...
object EventBus : CoroutineScope {
    ...
    fun <T> register(
        ...
        eventDataMap[eventClass] = EventData(
            this,
            eventDispatcher,
            eventCallback,
            eventFail
    ...
    fun <T> unregister(contextName: String, eventClass: Class<T>) {
        contextMap[contextName]?.remove(eventClass)
    }
